...
*/
func NewSQLiteStorage(connectionInformation *slurperio.ConnectionInformation, logger *slog.Logger) *SQLiteStorage {
...
func (storage *SQLiteStorage) Connect() error {
	dsn := fmt.Sprintf("file:%s?cache=shared&mode=rwc", storage.connectionInformation.Filename)
...
func (storage *SQLiteStorage) Create() error {
	storage.logger.Info("Creating database tables...")
	...
	storage.logger.Info("Created tables successfully.")
	return nil
}
...
*/
func (storage *SQLiteStorage) GetAttachment(mailID, attachmentID string) (*model.Attachment, error) {
...
*/
func (storage *SQLiteStorage) GetMailByID(mailItemID string) (*model.MailItem, error) {
...
*/
func (storage *SQLiteStorage) GetMailCollection(offset, length int, mailSearch *MailSearch) ([]*model.MailItem, error) {
...
*/
func (storage *SQLiteStorage) StoreMail(mailItem *model.MailItem) (string, error) {
	var err error
