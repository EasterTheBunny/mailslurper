...
*/
func NewMySQLStorage(connectionInformation *slurperio.ConnectionInformation, logger *slog.Logger) *MySQLStorage {
	return &MySQLStorage{
...
*/
func (storage *MySQLStorage) GetAttachment(mailID, attachmentID string) (*model.Attachment, error) {
...
*/
func (storage *MySQLStorage) GetMailByID(mailItemID string) (*model.MailItem, error) {
...
*/
func (storage *MySQLStorage) GetMailCollection(offset, length int, mailSearch *MailSearch) ([]*model.MailItem, error) {
...
*/
func (storage *MySQLStorage) StoreMail(mailItem *model.MailItem) (string, error) {
	var err error
